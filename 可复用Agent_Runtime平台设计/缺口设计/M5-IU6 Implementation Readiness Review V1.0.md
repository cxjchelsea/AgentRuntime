...
BLOCKERS = 1
FORMAL IMPLEMENTATION = PAUSED AT STEP-REPLAY BOUNDARY
~~~
...
~~~text
B-M5-IU6-008 = OPEN
REQUIRES CA-M5-IU6-04

M5-IU6 IMPLEMENTATION READINESS = NOT_READY
FORMAL IMPLEMENTATION = PAUSED_AT_STEP_REPLAY_BOUNDARY
~~~
...
~~~text
M5-IU6 IMPLEMENTATION READINESS RE-REVIEW = SUPERSEDED_BY_B-M5-IU6-008
M5-IU6 IMPLEMENTATION READINESS = NOT_READY
~~~
...
NEW BLOCKER = B-M5-IU6-008

CA-M5-IU6-04 = IN PROGRESS

NEXT REQUIRED:
CA-M5-IU6-04 Targeted Amendment Review
→ four local gates
→ M5-IU6 Readiness Re-Review
→ resume Step-level M5-IU6 Formal Implementation
